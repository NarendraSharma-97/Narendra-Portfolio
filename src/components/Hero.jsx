import profilePic from "../assets/Narendra_kumar_sharma_compressed_logo.jpeg"
            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                ...
                className="w-full lg:w-1/2 lg:pt-16 ">
                        <div className="flex flex-col items-center lg:items-start mt-10">
                            ...
                            <motion.a
                            variants={childVariants}
                            href="/Narendra_Kumar_Sharma_Frontend_Developer_3.8+ Years of Experience.pdf"
                            target="_blank"
